...
const ProductLoadAnim = () => {
    return (
        <div classNameName="relative shadow-md rounded-md">
            <div className="animate-pulse">
                <div classNameName="w-full min-h-70 bg-gray-200 aspect-w-1 aspect-h-1 rounded-t-md overflow-hidden group-hover:opacity-75 lg:h-80 lg:aspect-none">
                    {/* Image */}
                </div>
            </div>
